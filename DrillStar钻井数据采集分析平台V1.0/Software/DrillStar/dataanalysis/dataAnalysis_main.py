...
class Win_DataAnalysis(QMainWindow):
    ...
    def initUI(self):
        ...
        self._setup_button(self.ui.btn_Model_NN, "icon/b_nn.png", "NeuralNetwork")
        ...
        self._setup_button(self.ui.btn_Model_LinearRegression, "icon/b_lr.png", "LinearRegression")
        self._setup_button(self.ui.btn_Model_LogisticRegression, "icon/b_lcr.png", "LogisticRegression")
    ...
    def _setup_button(self, btn, icon_path, text):
    ...
    def on_Clicked_Model_NN(self):
        self._create_node(
            "icon/n_nn.png", "node_Moedl_NN", "NeuralNetwork", [3], [1], self._placeholder_window("NeuralNetwork")
        )

    def on_Clicked_Model_LSTM(self):
        self._create_node("icon/n_lstm.png", "node_Moedl_Lstm", "Lstm", [3], [1], self._placeholder_window("Lstm"))

    def on_Clicked_Model_NB(self):
        self._create_node(
            "icon/n_bn.png", "node_Moedl_NaiveBayes", "NaiveBayes", [3], [1], self._placeholder_window("NaiveBayes")
        )

    def on_Clicked_Model_Informer(self):
        self._create_node(
            "icon/n_informer.png", "node_Moedl_Informer", "Informer", [3], [1, 2], self._placeholder_window("Informer")
        )
    ...
    def on_Clicked_Model_LinearRegression(self):
        self._create_node(
            ...
            [3],
            [1],
            self._placeholder_window("LinearRegressions"),
        )
    ...
    def on_Clicked_Model_LogisticRegression(self):
        self._create_node(
            ...
            [3],
            [1],
            self._placeholder_window("LogisticRegression"),
        )

    def on_Clicked_Model_SaveModel(self):
        self._create_node(
            "icon/n_savemodel.png", "node_Moedl_SaveModel", "SaveModel", [4], [], self._placeholder_window("SaveModel")
        )

    def on_Clicked_Model_LoadModel(self):
        self._create_node(
            "icon/n_loadmodel.png", "node_Moedl_LoadModel", "LoadModel", [], [1], self._placeholder_window("LoadModel")
        )
